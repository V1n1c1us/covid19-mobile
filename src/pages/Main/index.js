...
import { Header, HeaderIcons, HeaderText, HeaderTitle, HeaderDescription, Container, CardContainer, Card,CardTitle, CardText, TitleSymptoms, InfoSymptoms, ContainerSymptoms, TextSymptoms, Footer, FooterText} from './styles';
...
export default function Main() {
  ...
  return (
    ...
    <Footer>
        <FooterText>Dados atualizado {moment(cases.lastUpdate).startOf('hour').fromNow()} @vfranceschi</FooterText>
      </Footer>
    </>
  );
}